...
func init() {
	ns := beego.NewNamespace("/v1",
		...
		beego.NSNamespace("/kpi",
			...
			beego.NSRouter("/listnew", &controllers.KpiController{}, "post:GetNewKPI"),
			...
			beego.NSRouter("/listSaleItem", &controllers.KpiController{}, "post:GetSaleItemKPI"),
		),
		...
		beego.NSNamespace("/reports",
			beego.NSRouter("/cli", &controllers.ReportsController{}, "post:GetClient"),
			beego.NSRouter("/ser", &controllers.ReportsController{}, "post:GetServer"),
		),
	)
